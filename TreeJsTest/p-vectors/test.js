...
function updateCameraPosition()
{
  ...
  // // direct line
  // drawVectorViewCamera();

  // // below line
  // drawVectorViewCamera(-0.1,-0.1,-0.1)

  // // direct spread x
  // for(var index = 0; index<1; index = index + 0.1)
  // {
  //   drawVectorViewCamera(index*(+1),-0.1,-0.1);
  //   drawVectorViewCamera(index*(-1),-0.1,-0.1);
  // }
  ...
  //   drawVectorViewCamera(index*(+1),-0.1,-0.1);
  //   drawVectorViewCamera(index*(-1),-0.1,-0.1);
  //   drawVectorViewCamera(-0.1,index*(+1),-0.1);
  //   drawVectorViewCamera(-0.1,index*(-1),-0.1);
  //   drawVectorViewCamera(-0.1,-0.1,index*(+1));
  //   drawVectorViewCamera(-0.1,-0.1,index*(-1));
  // }  
